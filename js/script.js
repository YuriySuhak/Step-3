...
class Visit {
    constructor(client, doctor, goal, status, urgency) {
        // this.id = "";
        this.client = client;
        this.doctor = doctor;
        this.goal = goal;
...
$("#new-card").on("submit", function(e){
    ...
    console.log(data);
    if (selectedDoctor.value === "cardiologist") {
        const visit = new VisitToCardiologist(data[6].value, data[8].value, data[7].value, data[9].value, data[1].value, data[10].value, data[2].value,  data[4].value, data[3].value)
        console.log(visit);
    };
    if (selectedDoctor.value === "dentist") {
        const visit = new VisitToDentist(data[6].value, data[1].value, data[7].value, data[2].value,  data[4].value, data[3].value)
        console.log(visit);
    };
    if (selectedDoctor.value === "therapist") {
        const visit = new VisitToTherapist(data[6].value, data[1].value, data[7].value, data[2].value,  data[4].value, data[3].value)
        console.log(visit);
    }
})